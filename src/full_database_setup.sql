...
-- Insert Default Users (Passwords are plain text for initial testing, handled by code)
INSERT INTO users_auth (user_id, username, role, password_hash) VALUES
('u_admin', 'admin1', 'ADMIN', 'adminpass'),
('u_inst1', 'inst1', 'INSTRUCTOR', 'instpass'),
('u_stu1', 'stu1', 'STUDENT', 'stupass'),
('u_stu2', 'stu2', 'STUDENT', 'stupass');
...
-- Sections (Deadlines set to future for testing)
INSERT INTO sections (id, course_code, instructor_id, day_time, room, capacity, semester, year, reg_deadline, drop_deadline) VALUES
('S1', 'CS101', 'u_inst1', 'Mon 10:00', 'C21', 50, 'Fall', 2025, '2025-12-30', '2025-12-30'),
('S2', 'CS202', 'u_inst1', 'Tue 14:00', 'C22', 40, 'Fall', 2025, '2025-12-30', '2025-12-30');

-- Enrollments
INSERT INTO enrollments (id, student_id, section_id, status) VALUES
('E1', 'u_stu1', 'S1', 'ACTIVE'),
('E2', 'u_stu2', 'S1', 'ACTIVE');